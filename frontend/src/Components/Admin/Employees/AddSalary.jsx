    ...
    <Box sx={{ position: 'relative', width: '100%', height: '100vh' }}>
      ...
      <Box
        sx={{
          ...
          right: 0,
          bottom: 0,
          backgroundImage: `url('https://media.cnn.com/api/v1/images/stellar/prod/skin-studio-lifestyle-cnnu.jpg?q=w_1110,c_fill/f_webp')`, // Background image
      ...
      >
        ...
        <Typography variant="h6" sx={{ marginBottom: 2 }}>Total Salary: {totalSalary}</Typography>
